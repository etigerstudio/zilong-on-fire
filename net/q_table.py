...
class QTable:
    def __init__(self, state_shape, actions, eps_greedy=0.1, eps_decay=1, reward_decay=0.9, learning_rate=0.03):
    ...
    def choose_action(self, state):
        if not self.detached and random.random() < self.eps_greedy:
